...
public class RADButton<T, R> extends Button implements RADControl<T, R> {
    ...
    public RADButton(String text) {
        super(text);

        selectedItemProperty().addListener(SelectedItemHelper.getActionListener(this, onActionProperty()));
    }
